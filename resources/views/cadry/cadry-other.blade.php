            ...
            <div class="tab-pane active" role="tabpanel">
                            ...
                            <div class="modal fade" id="addintiz" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('add_discip_cadry',['id' => $cadry->id])}}" method="post">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label>Sanasi:</label>
                                                    <input type="date" class="form-control" name="date_action" required>   
                                                </div>    
                                                <div class="mb-3">
                ...
                <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <div class="modal fade" id="editdiscip{{$discip->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="{{route('edit_discip_cadry',['id' => $discip->id])}}" method="post">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label>Prikaz Nomer:</label>
                                                <input type="text" class="form-control" name="edit_number" value="{{$discip->number}}" required>   
                                            </div> 
                                            <div class="mb-3">
                                                <label>Sanasi:</label>
                                                <input type="date" class="form-control" name="edit_date_action" value="{{$discip->date_action}}" required>   
                                            </div>    
                                            <div class="mb-3">
                                                <label>Jazo turi:</label>
                                                <input type="text" class="form-control" name="edit_type_action" value="{{$discip->type_action}}" required>   
                                            </div> 
                                            <div class="mb-3">
                                                <label>Jazo sababi:</label>
                                                <input type="text" class="form-control" name="edit_reason_action" value="{{$discip->reason_action}}" required>   
                                            </div>    
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn btn-primary" type="submit"> <i class="fas fa-save"></i> Saqlash </button>
                    ...
                    <div class="modal fade" id="addmed" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{route('add_med_cadry',['id' => $cadry->id])}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Oxirgi o'tilgan sanasi:</label>
                                            <input type="date" class="form-control" name="date1" required>   
                                        </div> 
                                        <div class="mb-3">
                                            <label>Xulosasi:</label></h6>
            ...
            <table class="table table-striped mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="180">
                            <button type="button" class="btn btn-soft-secondary waves-effect"
                                data-bs-toggle="modal" data-bs-target="#editmed{{$med->id}}">
                                <i class="bx bx-edit font-size-16 align-middle"></i>
                            </button>
                            <button type="button" class="btn btn-soft-danger waves-effect"
                                data-bs-toggle="modal" data-bs-target="#deletemed{{$med->id}}">
                                <i class="bx bx-trash font-size-16 align-middle"></i>
                            </button> 
                        </td>
                    </tr>
                    <div class="modal fade" id="editmed{{$med->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="{{route('edit_med_cadry',['id' => $med->id])}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Oxirgi o'tilgan sanasi:</label>
                                            <input type="date" class="form-control" name="date1" value="{{$med->date1}}" required>   
                                        </div> 
                                        <div class="mb-3">
                                            <label>Xulosasi:</label></h6>
                                            <input type="text" class="form-control" name="result" value="{{$med->result}}" required>   
                                        </div>    
                                        <div class="mb-3">
                                            <label>Keyingi o'tish sanasi:</label>
                                            <input type="date" class="form-control" name="date2" value="{{$med->date2}}" required>   
                                        </div>    
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn btn-primary" type="submit"> <i class="fas fa-save"></i> Saqlash </button>
                    ...
                    <div class="modal fade" id="deletemed{{$med->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Ma'lumotni taxrirlash</h5>
                                ...
                                <form action="{{route('delete_med_cadry',['id' => $med->id])}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="mb-3">
                    ...
                    <div class="modal fade" id="addincentive" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="{{route('add_incentive_cadry',['id' => $cadry->id])}}" method="post">
                                    @csrf
                                    <div class="modal-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label>Sanasi:</label>
                                            <input type="date" class="form-control" name="incentive_date" required>   
                                        </div>   
                                        <div class="mb-3">
        ...
        <table class="table table-striped mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="180">
                        <button type="button" class="btn btn-soft-secondary waves-effect"
                            data-bs-toggle="modal" data-bs-target="#editicentive{{$incentive->id}}">
                            <i class="bx bx-edit font-size-16 align-middle"></i>
                        </button>
                        <button type="button" class="btn btn-soft-danger waves-effect"
                            data-bs-toggle="modal" data-bs-target="#deleteicentive{{$incentive->id}}">
                            <i class="bx bx-trash font-size-16 align-middle"></i>
                        </button>  
                    </td>
                </tr>
                <div class="modal fade" id="editicentive{{$incentive->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Ma'lumot qo'shish</h5>
                            ...
                            <form action="{{route('edit_incentive_cadry',['id' => $incentive->id])}}" method="post">
                                @csrf
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label>Kim tomonidan:</label>
                                        <input type="text" class="form-control" name="by_whom" value="{{$incentive->by_whom}}" required>   
                                    </div> 
                                    <div class="mb-3">
                                        <label>Buyruq raqami:</label>
                                        <input type="text" class="form-control" name="number" value="{{$incentive->number}}" required>   
                                    </div> 
                                    <div class="mb-3">
                                        <label>Sanasi:</label>
                                        <input type="date" class="form-control" name="incentive_date" value="{{$incentive->incentive_date}}" required>   
                                    </div>   
                                    <div class="mb-3">
                                        <label>Rag'bat turi:</label>
                                        <input type="text" class="form-control" name="type_action" value="{{$incentive->type_action}}" required>   
                                    </div>   
                                    <div class="mb-3">
                                        <label>Rag'bat sababi:</label>
                                        <input type="text" class="form-control" name="reason_action" value="{{$incentive->type_reason}}" required>   
                                    </div>     
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-primary" type="submit"> <i class="fas fa-save"></i> Saqlash </button>
                ...
                <div class="modal fade" id="deleteicentive{{$incentive->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Ma'lumotni o'chirish</h5>
                            ...
                            <form action="{{route('delete_incentive_cadry',['id' => $incentive->id])}}" method="post">
                                @csrf
                                <div class="modal-body">
                                    <div class="mb-3">
