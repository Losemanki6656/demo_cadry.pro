    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ $department_name }} xodimlari</h4>
                            ...
                            <div id="datatable_filter" class="dataTables_filter">
                                <label>
                                    <a href="{{ route('addworker') }}" type="button"
                                        ...
                                        <i class="bx bx-plus font-size-16 align-middle me-2"></i> Xodim qo'shish
                                    </a>
                                </label>
                            </div>
                        </div>
                                    ...
                                    @foreach ($cadries as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-center"><img class="rounded avatar"
                                                    src="{{ asset('storage/' . $item->photo) }}" height="40" width="40">
                                            </td>
