...
<body style="padding: 0; margin-top: 0in">
    <table class="table" cellpadding="0" cellspacing="0"
        style="margin-left:-25.5pt; margin-top: 0in; border-collapse:collapse;">
        <tr>
        ...
        <tbody>
            <tr>
                <td colspan="8" style="text-align: center;  font-size: 18.5">
                    <b>MA'LUMOTNOMA<b>
                            <p style="margin-bottom: 0px; margin-top: 0px"><b>{{ $cadry->last_name }}
                                    {{ $cadry->first_name }} {{ $cadry->middle_name }}</b></p>
                </td>
            </tr>
            <tr>
                <td colspan="7"></td>
                <td style="text-align: right" rowspan="8">
                    <img src="{{$photo}}" width="112" height="153">
                </td>
            </tr>
            ...
            <tr style="font-size: 14.5px;">
                <td colspan="8">
                    <b>Xalq deputatlari respublika, viloyat, shahar va tuman Kengashi deputatimi yoki boshqa
                        saylanadigan organlarning a'zosimi(to'liq ko'rsatilishi lozim):</b>
                </td>
            </tr>
            <tr style="font-size: 14.5px; margin-bottom: 4pt">
                <td colspan="8">
    ...
    <b style="text-align:center; font-size:12.0pt; margin-top: 0px">{{ $cadry->last_name }} {{ $cadry->first_name }}
        {{ $cadry->middle_name }}ning yaqin qarindoshlari haqida ma'lumot</b>

    <p style="text-align:center; margin-bottom: 5px; margin-top: 0px"><b><span>MA'LUMOT</span></b></p>

    <table class="table" cellpadding="0" cellspacing="0"
        style="margin-left:-25.5pt; border-collapse:collapse; border:none; text-align: center;  font-size: 14.5">
        <tr>
