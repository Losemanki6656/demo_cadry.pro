                  ...
                  <div class="d-flex">
                              ...
                              <form class="p-3">
                                  <div class="form-group m-0">
                                      <div class="input-group">
                                          <input type="text" class="form-control" placeholder="{{ __('messages.search') }} ..." aria-label="Search Result">
                      ...
                      <div class="dropdown d-none d-sm-inline-block">
                          <button type="button" class="btn header-item"
                                data-bs-toggle="dropdown" id="" aria-haspopup="true" aria-expanded="false">
                                @if (session()->get('locale') == 'ru')
                                    <img id="language_img" src="{{asset('assets/images/flags/ru.jpg')}}" alt="Header Language" height="16">
                                @elseif(session()->get('locale') == 'uz')
                                    <img id="language_img" src="{{asset('assets/images/flags/uz.jpg')}}" alt="Header Language" height="16">
                                @else
                                    <img id="language_img" src="{{asset('assets/images/flags/us.jpg')}}" alt="Header Language" height="16">
                                @endif
                          </button>
                          <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{url('change/locale/uz')}}" class="dropdown-item notify-item language" data-lang="uz">
                                    <img src="{{asset('assets/images/flags/uz.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">O'zbekcha</span>
                                </a>
                                <a href="{{url('change/locale/ru')}}" class="dropdown-item notify-item language" data-lang="ru">
                                    <img src="{{asset('assets/images/flags/ru.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                                <a href="{{url('change/locale/en')}}" class="dropdown-item notify-item language" data-lang="en">
                                  ...
                                  <a href="#!" class="text-reset notification-item">
                                      <div class="d-flex">
                                          <div class="flex-shrink-0 me-3">
                                              <img src="{{asset('assets/images/logo.png')}}" class="rounded-circle avatar-sm" alt="user-pic">
                                          </div>
                      ...
                      <div class="dropdown d-inline-block">
                          ...
                          data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <img class="rounded-circle header-profile-user" src="{{asset(Auth::user()->userorganization->photo)}}"
                                  alt="Header Avatar">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                              <!-- item-->
                              <a class="dropdown-item" href="{{route('user_edit')}}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
                         ...
                         @can('role-list')
                            ...
                            <li>
                              ...
                              <ul class="sub-menu" aria-expanded="false">
                                  <li><a href="{{route('incentives')}}" data-key="t-user-list">Rag'batlanirishlar</a></li>
                              </ul>
                          </li>
                            <li>
          ...
          <div class="main-content">
              ...
              <footer class="footer">
                  <div class="container-fluid">
                      <div class="row">
                          <div class="col-sm-6">
                              <script>document.write(new Date().getFullYear())</script> © Exodim. All rights Reserved
                          </div>
                          <div class="col-sm-6">
